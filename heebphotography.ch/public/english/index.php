        ...
        <section>
            ...
            if (is_dir($dir)) {
                ...
                foreach ($scan as $value) {
                    if ($is_first_tester) {
                        if (!(is_dir($value))) {
                            echo "<div class=\"slides\" id=\"first_slide\" style=\"background: url($dir/$value), linear-gradient(to top, transparent, white);\"></div>";
                            $is_first_tester = false;
                        }
                    } else {
                        if (!(is_dir($value))) {
                            echo "<div class=\"slides\" style=\"background: url($dir/$value), linear-gradient(to top, transparent, white);\"></div>";
                        }
                    }
                }
            }
