...
<html lang="en">
    ...
    <head>
        ...
        <meta name="keywords" content="english, andreas, heeb, andreas heeb, contact, heebphotography, message">
        <meta name="description" content="Contact Formular for Questions or anything similar">
        <!-- rest -->
