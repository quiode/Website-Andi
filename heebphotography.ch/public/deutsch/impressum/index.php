...
<html lang="en" style="scrollbar-width: none;">
    ...
    <head>
        ...
        <meta name="keywords" content="deutsch, andreas, heeb, andreas heeb, impressum, heebphotography, rechtliches, legales">
        <meta name="description" content="Impressum und Legales zu der Webseite Heebphotography.ch">
        <!-- rest -->
        <title>Impressum | Tierfotografie Andreas Heeb</title>
    ...
    <body id="impressum">
        ...
        <section id="german" class="impressum_text">
            <article id="contact_address">
                <p class="title">Kontakt-Adresse</p>
                <p>Andreas Heeb<br />Bachtelstrasse 16<br />8640 Rapperswil-Jona<br />Schweiz</p>
                <p>E-Mail:<br />andreas.heeb@heebphotography.ch</p>
            </article>
            <article id="disclaimer">
                <p class="title">Haftungsausschluss</p>Der Autor &uuml;bernimmt keinerlei Gew&auml;hr hinsichtlich
            ...
            <article id="exclusion_of_liability_for_links">
                <p class="title">Haftungsausschluss f&uuml;r Links</p>
            ...
            <article id="copyright">
                <p class="title">Urheberrechte</p>
                <p>Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf dieser
                    Website, geh&ouml;ren ausschliesslich Dominik Schwaiger, Andreas Heeb and Milena
                    Bachofen oder den speziell genannten
        ...
        <section id="english" style="display: none;" class="impressum_text">
            <article id="contact_address">
