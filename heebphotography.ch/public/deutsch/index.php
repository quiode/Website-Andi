...
<html lang="en">
    ...
    <head>
        ...
        <meta name="keywords" content="deutsch, andreas, heeb, andreas heeb, startseite, heebphotography, start, homepage">
        <meta name="description" content="Startseite von Heebphotography.ch">
        <!-- rest -->
